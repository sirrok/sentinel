...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to zaliasd "gobject list" output
    ...
    def zaliasd_serialise(self):
        import zaliaslib
        return zaliaslib.SHIM_serialise_for_zaliasd(self.serialise())
